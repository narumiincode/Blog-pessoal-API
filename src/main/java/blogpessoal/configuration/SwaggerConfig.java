package blogpessoal.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("blogpessoal.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/narumiincode")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Richard Narumi", 
			"https://github.com/narumiincode", 
			"Richardnarumi3@gmail.com");
